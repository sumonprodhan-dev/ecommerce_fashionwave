                    ...
                    <div class="col-lg-8">
                        <div class="header-top-right">
                            ...
                            <div class="account-switcher">
                                <span class="flag"><img src="assets/images/user-avatar11.png" alt="fashionwave"></span>
            ...
            <div class="container">
                <div class="header-middle-wrap">
                    <div class="brand-area">
                        <a class="brand-logo" href="index.html"><img class="brand-image" src="assets/images/logo.png"
                                alt="Fashionwave" /></a>
                    </div>
